...
public class SoundPopup extends Popup {
    ...
    public SoundPopup(KIFFLARM kifflarm, SetAlarmPopup setAlarmPopup){
        super(kifflarm);
        ...
        SoundPopupAdapter soundPopupAdapter = new SoundPopupAdapter(recyclerView, soundManager, setAlarmPopup, this);
