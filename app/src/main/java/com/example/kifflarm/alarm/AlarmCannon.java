...
import com.example.kifflarm.alarm.receivers.NotificationDismissedReceiver;
...
public class AlarmCannon {
    ...
    private RemoteViews getRemoteViews(Alarm alarm){
        ...
        remoteViews.setTextColor(R.id.notificationTV, Utils.getContrastColor(Utils.getRandomColor()));
